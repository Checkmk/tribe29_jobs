...
Our offices are located in the heart of Munich, in Haidhausen, a district known for its many coffee shops, restaurants, bars, and small shops. To enable our high growth, we
are looking for a
...
You are responsible for the design, development and testing of new monitoring features
You support the connection of new IoT devices, IT hardware and software services in close cooperation with customers
You support the maintenance of our software

## Your Profile
Backend developer with experience in Python
Good knowledge of  Linux
Friend of open source software
At least one year of professional experience in software development
Ideally FH or university degree in computer science or comparable training
Agile mindset and experience with agile development practices (TDD, CI, Pair Programming, Scrum, Kanban, ...)
Passion for current technology developments and their possible applications
Strong ability to grasp complex tasks and respond with uncomplicated solutions
...
Ideally, you have knowledge and experience with the following technologies we use: Git, Gerrit, Jenkins, pytest, Pylint, JIRA.
